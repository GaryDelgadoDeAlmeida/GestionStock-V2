...
namespace GestionStock_V2
{
    public partial class Index : Form
    {
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Do you want to exit without saving ?", "Exit", MessageBoxButtons.YesNo);
        ...
        {
            this.OpenForms(new Clients());
        }

        private void btnShopping_Click(object sender, EventArgs e)
        {
            this.OpenForms(new Shoppings());
        }
